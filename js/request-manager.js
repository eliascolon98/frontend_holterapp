...
document
  .getElementById("delete-patient")
  .addEventListener("click", deletePatient);
document
  .getElementById("update-patient")
  .addEventListener("click", showUpdatePatient);
document
document
...
document
  .getElementById("close-new-request-2")
  .addEventListener("click", closeServiceRequest);
document
...
function showUpdatePatient() {
  fadeTransition("actualizar-solicitud", "solicitudes");
}
...
function closeServiceRequest() {
  ...
  fadeTransition("solicitudes", "actualizar-solicitud");
}
...
function deletePatient() {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      Swal.fire(
        '¡Eliminado!',
        'Este pacinete ah sido eliminado',
        'success'
      )
    }
  })
